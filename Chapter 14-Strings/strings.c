//
// Created by edragain on 3/13/25.
//
#include "../mpc.h"
...
enum {
    ...
    LVAL_FUN, LVAL_SEXPR, LVAL_QEXPR, LVAL_NULL, LVAL_OK,LVAL_FILE
};
...
#define LASSERT_TWO_TYPE(func, args, index, expect1,expect2) \
